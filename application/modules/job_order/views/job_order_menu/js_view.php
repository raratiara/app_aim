        ...
        success: function(data)
        {
			if(data != false){ 
				...
				if(save_method == 'detail'){ 
					$('span.date_pekerjaan').html(data.date);
					$('span.order_no').html(data.order_no);
					$('span.order_name').html(data.order_name);
					$('span.floating_crane').html(data.floating_crane_name);
					$('span.mother_vessel').html(data.mother_vessel_name);
					$('span.pic').html(data.pic);
					$('span.datetime_start').html(data.datetime_start);
					$('span.datetime_end').html(data.datetime_end);
					$('span.total_time').html(data.date_time_total);
