...
INSERT INTO `activity` VALUES (1,'Loading Preparation',NULL,1,1),(2,'Transshipment',NULL,1,2),(3,'Abnormality',NULL,1,3),(4,'Test Crane/P2H',1,1,1),(5,'Barge ALong side',1,1,2),(6,'Loading Time',2,1,1),(7,'VIDS',2,1,6),(8,'Final Trimming',2,1,7),(9,'Loading',2,1,8),(10,'VFDS',2,1,9),(11,'Transfer HE from MV/BG',2,1,10),(12,'Barge Cast Off',2,1,11),(13,'Logistic Supply',3,1,1),(14,'Repair',3,1,2),(15,'Bad Weather',3,1,3),(16,'WOTH',3,1,4),(17,'WCD',3,1,5),(18,'Waiting TB',3,1,6),(20,'Shiftting FC',2,1,2),(21,'Shifting BG',2,1,3),(22,'Transfer H/E dari FC ke Tongkang (THBG)',2,1,4),(23,'Transfer H/E dari Tongkang ke FC (THFC)',2,1,5);
...
INSERT INTO `floating_crane` VALUES (1,'FC001','FC Avant Grade','-6.25618','106.98926'),(2,'FC002','crane dua',NULL,NULL),(3,'FC002','FC Avant 3','-6.25620','106.98930');
...
INSERT INTO `job_order` VALUES (1,'2025-02-26','ORD25020001','Perpindahan Batubara',1,2,'Rara','2025-02-26 08:00:00','2025-02-26 21:15:00',145,3,NULL,NULL,NULL,NULL,1),(2,'0000-00-00','ORD25020002','order 1',2,2,'tiara','0000-00-00 00:00:00','0000-00-00 00:00:00',0,2,NULL,NULL,NULL,NULL,1),(3,'0000-00-00','ORD25020003','order 2',2,2,'sani','0000-00-00 00:00:00','0000-00-00 00:00:00',0,2,NULL,NULL,NULL,NULL,1),(4,'2025-02-27','ORD25020004','Perpindahan Batubara',1,2,'tisya','2025-02-28 15:00:00','2025-02-28 16:20:00',100,2,NULL,NULL,NULL,NULL,1),(5,'2025-02-27','ORD25020005','Perpindahan 2',1,2,'tisya','2025-02-28 10:00:00','2025-02-28 11:04:00',64,2,NULL,NULL,NULL,NULL,1),(6,'2025-02-28','ORD25020006','Perpindahan Batubara',1,2,'niel','2025-02-28 00:00:00','2025-02-28 02:20:00',140,2,NULL,NULL,NULL,NULL,1),(7,'2025-02-28','ORD25020007','Perpindahan 2',1,2,'ika','2025-02-28 08:00:00','2025-02-28 10:05:00',125,2,NULL,NULL,NULL,NULL,1),(8,'2025-02-28','ORD25020008','Perpindahan 3',1,2,'ika','2025-02-28 08:00:00','2025-02-28 10:15:00',135,2,NULL,NULL,NULL,NULL,1);
...
INSERT INTO `job_order_detail` VALUES (1,1,6,'2025-03-01 10:10:43','2025-03-01 10:12:00',2,120,NULL,NULL,'121',1),(2,7,3,'2025-03-01 05:44:43','2025-03-01 05:44:43',0,180,NULL,NULL,'90',0),(3,1,6,'2025-03-01 10:15:43','2025-03-01 10:16:43',1,125,NULL,NULL,'126',1),(4,1,6,'2025-03-17 11:00:00','2025-03-01 11:05:00',5,130,NULL,NULL,'137',0);
...
INSERT INTO `job_order_summary` VALUES (1,1,6,14.5),(2,1,13,10.2);
...
CREATE TABLE `user_akses_role` (
  ...
  KEY `user_menu_id` (`user_menu_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1356 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-24 14:26:47
